...
# Check if the API keys were successfully loaded
if not all([VIRUSTOTAL_API_KEY, ABUSEIPDB_API_KEY, SHODAN_API_KEY]):
    raise ValueError("Please make sure all API keys are provided in the .env file.")
